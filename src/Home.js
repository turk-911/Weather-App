...
import Icon from "react-native-vector-icons/Ionicons"; // Correct import for Icon
    ...
    <View>
      ...
      >
        ...
        <View style={{ paddingHorizontal: 20, marginTop: 100 }}>
          <Text style={{ fontSize: 40, color: "white" }}>Hello Mokshe</Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Cards
                name={item.name}
                image={item.image}
                navigation={props.navigation} // Fixed typo
              />
            )}
          />
        </View>
